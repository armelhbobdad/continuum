...
const downloadItemVariants = cva("rounded-lg border p-3 transition-colors", {
  variants: {
    status: {
      ...
      verifying: "border-blue-500/50 bg-blue-50/50 dark:bg-blue-950/20",
      verified: "border-green-500/50 bg-green-50/50 dark:bg-green-950/20",
      corrupted: "border-red-500/50 bg-red-50/50 dark:bg-red-950/20",
